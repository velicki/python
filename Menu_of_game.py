...
def menu_of_game(jezik,p1color,p2color,p1_up,p1_down,p2_up,p2_down):
...
#-----------------------------------------------
    ...
    con = buttonb(chosen_language(jezik)[2], change_controll)

    col = buttonb(chosen_language(jezik)[3], change_color)

    s_g = buttonb(chosen_language(jezik)[4], start_new_game)
