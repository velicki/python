...
def game(jezik, p1color, p2color,p1_up,p1_down,p2_up,p2_down):
    ...
    def windows_configuration():
        ...
        Tenis_Game.title(chosen_language(jezik))                # Ime prozora
...
#-----------------------------------------------
        ...
        if (coordinates[0]>=(WIDTH-65) and coordinates[0]<=(WIDTH-65+xVelocity)):
            if (coordinates[1]>position2[1]-20 and coordinates[1]<(position2[1]+120)):  #provera da li je igrac udario lopticu
